...
RUN curl -O https://download.newrelic.com/newrelic/java-agent/newrelic-agent/current/newrelic-java.zip --output $PROJECT_HOME && unzip $PROJECT_HOME/newrelic-java.zip 
