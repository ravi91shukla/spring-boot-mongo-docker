...
RUN cd ..
RUN chown -R   /var/lib/jenkins/workspace/automation/target/
RUN java -jar -javaagent:/home/ubuntu/newrelic/newrelic.jar /var/lib/jenkins/workspace/automation/target/spring-boot-mongo-1.0.jar
